# Completed-change workflow

The user explicitly requires GitHub synchronization whenever a change is completed in this project.

- After completing and validating a change, commit its related files and push to the configured GitHub remote. A local-only commit does not complete the workflow.
